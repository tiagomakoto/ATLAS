...
# 4. COTAHIST except (20 spaces except, 24 pbar.write, 35 f-string line, 24 pbar.update, 24 continue)
...
# 5. df_raw.empty (20 if, 24 pbar.write, 35 f-string, 24 pbar.update, 24 continue)
...
# 6. n_op == 0 (20 if, 24 pbar.write, 35 f-string, 24 pbar.update, 24 continue)
...
# 7. enrichment except (20 except, 24 pbar.write, 35 f-string1, 35 f-string2, 24 pbar.update, 24 continue)
...
# 8. df_enr.empty (20 if, 24 pbar.write, 35 f-string, 24 pbar.update, 24 continue)
