...
def executar_gate(ticker: str) -> str:
    ...
    # Verifica estabilidade entre os dois Ãºltimos anos completos do histÃ³rico
    ...
    print(f"  IR mÃ©dio {ano_anterior}: {ir_ano_anterior:+.3f}")
    print(f"  IR mÃ©dio {ano_mais_recente}: {ir_ano_atual:+.3f}")
    print(f"  DiferenÃ§a:     {abs(ir_ano_atual-ir_ano_anterior):+.3f}")
