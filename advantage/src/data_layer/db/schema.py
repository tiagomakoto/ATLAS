def create_all_tables() -> None:
    """
    Inicializa todos os bancos e cria todas as tabelas se nao existirem.
    Idempotente - seguro chamar multiples vezes.
    """
    ...
    try:
        ...
        # Tabela intraday_slot
        conn.execute("""CREATE TABLE IF NOT EXISTS intraday_slot (
        ticker TEXT NOT NULL,
        ...
        # Tabela preco_volume
        conn.execute("""CREATE TABLE IF NOT EXISTS preco_volume (
        ticker TEXT NOT NULL,
        data DATE NOT NULL,
        abertura REAL,
        maxima REAL,
        ...
        conn.execute("""CREATE TABLE IF NOT EXISTS indicadores_compartilhados (
        ticker TEXT NOT NULL,
        data DATE NOT NULL,
        sma_20 REAL,
        sma_50 REAL,
    ...
    try:
        ...
        # Tabela commodities_setoriais
        conn.execute("""CREATE TABLE IF NOT EXISTS commodities_setoriais (
        data DATE NOT NULL,
        ...
        # Tabela macro_brasil
        conn.execute("""CREATE TABLE IF NOT EXISTS macro_brasil (
        data DATE NOT NULL,
        selic_meta REAL,
        selic_efetiva REAL,
        ipca_mensal REAL,
        ...
        # Tabela macro_global
        conn.execute("""CREATE TABLE IF NOT EXISTS macro_global (
        data DATE NOT NULL,
        fed_funds_rate REAL,
        us_10y_yield REAL,
        dxy REAL,
        ...
        conn.execute("""CREATE TABLE IF NOT EXISTS focus_bcb_historico (
        data_referencia DATE NOT NULL,
    ...
    try:
        ...
        # Tabela polymarket_eventos
        conn.execute("""CREATE TABLE IF NOT EXISTS polymarket_eventos (
        data DATE NOT NULL,
        timestamp TIMESTAMP NOT NULL,
        ...
        # Tabela dados_setoriais_br
        conn.execute("""CREATE TABLE IF NOT EXISTS dados_setoriais_br (
        data_referencia DATE NOT NULL,
        indicador TEXT NOT NULL,
        valor REAL,
        ...
        conn.execute("""CREATE TABLE IF NOT EXISTS temperatura_noticias (
        ticker TEXT,
        data DATE NOT NULL,
        ...
        conn.execute("""CREATE TABLE IF NOT EXISTS aneel_energia (
        data DATE NOT NULL,
        consumo_mwh REAL,
        variacao_12m REAL,
        data_coleta TIMESTAMP NOT NULL,
        ...
        # Tabela abpo_papelao
        conn.execute("""CREATE TABLE IF NOT EXISTS abpo_papelao (
        data DATE NOT NULL,
        producao_ton REAL,
        variacao_12m REAL,
        fonte_url TEXT,
        ...
        # Tabela iie_fgv
        conn.execute("""CREATE TABLE IF NOT EXISTS iie_fgv (
        data DATE NOT NULL,
        iie_total REAL,
    ...
    try:
        ...
        # Tabela scores_causa
        conn.execute("""CREATE TABLE IF NOT EXISTS scores_causa (
        ticker TEXT NOT NULL,
        data DATE NOT NULL,
        score_fluxo REAL,
        ...
        conn.execute("""CREATE TABLE IF NOT EXISTS portfolio_estado (
