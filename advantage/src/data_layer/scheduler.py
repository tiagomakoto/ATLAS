...
def verificar_jobs_perdidos():
    ...
    try:
        ...
        for job in jobs:
            # No APScheduler 3.11+, next_run_time é um atributo de job
...
def main():
    ...
    @cscheduler.scheduled_job(CronTrigger(hour=18, minute=30))
    ...
    @cscheduler.scheduled_job(CronTrigger(hour=19, minute=0))
    ...
    @cscheduler.scheduled_job(CronTrigger(hour=19, minute=30))
    ...
    @cscheduler.scheduled_job(CronTrigger(day_of_week='mon', hour=8))
    def job_alternativo():
        try:
    ...
    @cscheduler.scheduled_job(IntervalTrigger(minutes=30))
    def job_noticias():
        try:
    ...
    @cscheduler.scheduled_job(CronTrigger(hour=20, minute=0))
    ...
    @cscheduler.scheduled_job(CronTrigger(hour=19, minute=45))
    def job_polymarket():
        try:
    ...
    @cscheduler.scheduled_job(CronTrigger(day=1, hour=8, minute=0))
    ...
    @cscheduler.scheduled_job(CronTrigger(day=1, hour=8, minute=15))
